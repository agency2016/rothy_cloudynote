...
class Users extends CI_Model 
{
    ...
    function get_user_access_level_id($category_id) {
        $query = $this->db->get_where('user_category', array('category_id' => $category_id));
        return $query->row()->user_access_role_id;
    }
	...
	{
        $data['user_access_level'] = $this->get_user_access_level_id($data['register_as']);
        unset($data['register_as']);
