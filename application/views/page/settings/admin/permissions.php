                        ...
                        <div class="cldnt-info-area">
                            <div class="row-fluid">
                                <div class="user-edit-form">
                                    <form class="form-horizontal" id="access_role_permission" action="<?php echo base_url('/admin/permissions'); ?>" name="access_role_permission_form"
                                          method="POST">
