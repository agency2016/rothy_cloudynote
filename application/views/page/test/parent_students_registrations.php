...
<div class="row-fluid row-title-bg">
    <div class="container">
        <h2 class="dashboard-heading">Parent/Student Registrations</h2>
    </div>
            ...
            <div class="table-area">
                    ...
                    <div class="span4">
                        <div class="student-form-group">
                            ...
                            <select id="class-filter" class="selectpicker">
                                <option selected="selected" >Parent Registrations</option>
                    ...
                    <div class="span4">
                        <div class="student-form-group">
                            ...
                            <select id="class-filter" class="selectpicker">
                                ...
                                <option>Parent 1 Name</option>
                                <option>Parent 2 Name</option>
                            </select>
                        </div>
                    </div>
                    <div class="span3">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <table class="table table-striped registration-table">
                            <tr>
                                <th></th>
                                <th>Student Name<span class="sort-down"><i class="fa fa-sort-down"></i></span><span class="sort-up"><i class="fa fa-sort-up"></i></span></th>
                                <th>School Name<span class="sort-down"><i class="fa fa-sort-down"></i></span><span class="sort-up"><i class="fa fa-sort-up"></i></span></th>
                                <th>Parent 1 Name<span class="sort-down"><i class="fa fa-sort-down"></i></span><span class="sort-up"><i class="fa fa-sort-up"></i></span></th>
                                <th>Email</th>
                                <th>Mobile</th>
                                <th>Parent 2 Name<span class="sort-down"><i class="fa fa-sort-down"></i></span><span class="sort-up"><i class="fa fa-sort-up"></i></span></th>
                                <th>Email</th>
                                <th>Mobile</th>
                ...
                <div class="row-fluid table-area-filter-bg">
                    ...
                    <div class="span4 selected-stu">
                        <p>Total number of registration 54</p>
                    </div>
                </div>
                <div class="row-fluid">
