                                ...
                                foreach ($note_parent_student as $student):
                                    ...
                                    <tr>
                                        ...
                                        <td><?php
                                            ...
                                            if ($student->response_note_reply == '0') {
                                                ?><i class="fa fa-times fa-2x"></i><?php
                                            } else if ($student->response_note_reply == '1') {
                                                ?><i class="fa fa-check fa-2x"></i><?php
                                            }
                                            ?>
                                        </td>
                                        <td><?php
                                            ...
                                            <?php
                                            //echo "<pre>";print_r($json);
                                            foreach ($parent_json as $note_item): //echo "<pre>";print_r(get_object_vars($note_item));
                                            if (!is_object($note_item)) {
                                                break;
                                            }
                                            ?>
                                        ...
                                        <td><?php
                                            if ($property == 'textbox') {
                                                ...
                                                echo $note->number_default_value;
                                            ...
                                            }else if ($property == 'address-box') {
                                                //echo "<pre>";
                                                //print_r($note);exit();
                                                echo 'Address : ' . $note->address . '</br>';
                                                echo 'Street : ' . $note->street . '</br>';
                                                echo 'Postal Code : ' . $note->postalcode . '</br>';
                                                echo 'City : ' . $note->city . '</br>';
                                                echo 'State : ' . $note->state . '</br>';
                                                echo 'Country : ' . $note->country . '</br>';
