...
// added new
    ...
    var tn = ['Tenth','Eleventh','Twelveth','Thirteenth', 'Fourteenth','Fifteenth','Sixteenth', 'Seventeenth','Eighteenth','Nineteenth']; var tw = ['Twenty','Thirty','Forty','Fifty', 'Sixty','Seventy','Eighty','Ninety'];
    ...
    var render_preview_form = function (cnote_info, val_note_name) {
                    ...
                    case 'payment-due':
                        ...
                        preview_form.push(
                            draggableItem
                                ...
                                .replace(/{default_dollar_value}/g, item[input_type].default_dollar_value)
                                .replace(/{default_cent_value}/g, item[input_type].default_cent_value)
                        );
                        preview_form.push(draggableItem.preview_control_group_end);
        ...
        preview_tab.html(preview_form.join(''));
    };
            ...
            $('.sortable-note-area').sortable({
                ...
                start: function (event, ui) {
                    ...
                    if (typeof currentItemHolder.html() != 'undefined' && !currentItemHolder.hasClass('slide-up')) {
                        ui.item.css('height', 'auto');
                        ui.item.find('i.control-group-icon').toggleClass('fa-plus-circle fa-minus-circle');
...
//                $('#'+current_type_id+current_type).hide();
            ...
            $('div.sortable-note-area').on('click', 'i.control-group-icon', function (ev) {
                ...
                if ($(currentItemHolder).hasClass('slide-up')) {
                    $(currentGroupIcon).removeClass('fa-plus-circle').addClass('fa-minus-circle');
                    $(currentItemHolder).slideDown('', function () {
                        $(currentItemHolder).removeClass('slide-up');
                    });
                } else {
                    $(currentGroupIcon).removeClass('fa-minus-circle').addClass('fa-plus-circle');
...
//function to format bites bit.ly/19yoIPO
            ...
            $('#note-wizard').bootstrapWizard({
                ...
                'onNext': function (tab, navigation, index) {
                    ...
                    if (!val_note_name) {
                        note_name.next().html('This Field id Required').show();
                        error = true;
                    } else {
            ...
            if (typeof reply_preview != 'undefined' && reply_preview == true) {
                ...
                $('#response-form').on('keyup', '.change-text', function () {
                    //console.log('hello');
